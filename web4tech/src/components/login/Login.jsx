        ...
        return(
            <div className="card" style={{ width: '35rem', margin: '0 auto'}}>
                <div className="card-body">
                    <h5 className="card-title"><img src={require('../../img/logo-h-vjobs.png')}/></h5>
                    ...
                    <div className="form-group col-12 text-right mb-0">
                        <button type="submit" className="btn btn-success" onClick={()=>{this.props.login(this.state.email,this.state.password)}}>Entrar</button>
                    </div>
                </div>
            </div>
        )
